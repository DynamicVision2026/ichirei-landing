// The JSON contract the engine returns and the frontend consumes.
// Kept in sync with the OUTPUT CONTRACT appendix in engine/prompt.md and
// with src/demo/types.ts (the frontend copy).
